    ...
    <section id="services" className="py-12 bg-white">
      <div className="container mx-auto px-2 max-w-[1400px]">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          We specialize in delivering tailored furniture and appliance solutions for businesses and institutions such as NDIS providers, real estate agencies, Airbnb hosts, hostels, restaurants, and government organizations. Whether you are furnishing a single space or an entire facility, our services are designed to meet your unique needs with quality, efficiency, and reliability. We are committed to providing ...
          </p>
        </div>
